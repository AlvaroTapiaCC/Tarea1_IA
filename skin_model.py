    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            if val_loss_avg < best_val_loss:
                ...
                print(f"Validation loss improved to {val_loss_avg:.4f}")
                torch.save(self.model.state_dict(), "best_model.pth")
        
        self.model.load_state_dict(torch.load("best_model.pth"))

class Evaluator():
    def __init__(self, model, device, threshold, train_loss_history=None, val_loss_history=None):
        self.model = model
        self.device = device
        self.threshold = threshold
    ...
    def loss_tra_val(self):
        if self.train_loss_history is None or self.val_loss_history is None:
            print("No loss history data available for plotting.")
            return
        ...
        plt.plot(epochs, self.val_loss_history, 'orange', label='Validation Loss')
